...
The site includes a high-contrast mode control in the header. Select **High contrast: off** to enable it; the preference is stored in the browser and restored on future page loads.
